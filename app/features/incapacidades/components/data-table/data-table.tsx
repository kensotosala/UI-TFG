  ...
  const aplicarFiltroFecha = (rango: string) => {
    ...
    if (rango === "todos") {
      setColumnFilters((prev) =>
        prev.filter((filter) => filter.id !== "fechaInicio"),
      );
      return;
    }
    ...
    setColumnFilters((prev) => {
      const otherFilters = prev.filter((filter) => filter.id !== "fechaInicio");
      return [
        ...otherFilters,
        {
          id: "fechaInicio",
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Select
          value={
            (table.getColumn("tipoIncapacidad")?.getFilterValue() as string) ??
            "TODOS"
          }
          onValueChange={(value) =>
            table
              .getColumn("tipoIncapacidad")
        ...
        {/* Rangos rápidos de fecha (fecha de inicio) */}
